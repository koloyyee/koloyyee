...
tags:
  ...
  - Productivity
description:
  Anti-multitasking and keep you in the zone, but there is a catch.
---
...
Multitasking is a lie; our brain can only make context switches between tasks, and our focus is the price. You might see "multitasking" as part of the job description, but no one can; in fact, it slows us down because it [takes up 25 minutes](https://hr.berkeley.edu/grow/grow-your-community/wisdom-café-wednesday/impact-interruptions#:~:text=When%20we%20start%20again%20on,minutes%20for%20more%20complex%20ones.) to "refocus". That's why we need to focus on one task at a time.

## What is time blocking?

[Time blocking](https://www.health.harvard.edu/mind-and-mood/focus-on-concentration#:~:text=Work%20in%20blocks%20of%20time,Salinas.) is a productivity technique that promotes doing one task during a set period of time. By segmenting our day into task blocks, we create mini deadlines and push ourselves to finish them on time. During the period, we should shut off from the world and get into the zone by limiting communication and distraction, but does it work?
...
If you are interested in following my journey of building this app, please stay tuned for my weekly blog post, or follow me on [X/Twitter](https://x.com/koloyyee).